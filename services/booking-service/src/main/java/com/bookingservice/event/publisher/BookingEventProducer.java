package com.bookingservice.event.publisher;
...
import com.event.PassengerNotificationData;
...
public class BookingEventProducer {
    ...
    public void sendBookingConfirmed(Booking booking,
        ...
        String duration       = flight != null ? flight.getFormatterDuration() : null;
        ...
        Double taxes            = fare != null ? fare.getTexesAndFees()             : null;
        BaggagePolicyResponse bag = fare != null ? fare.getBaggagePolicy()          : null;
        Integer ciPieces        = bag  != null ? bag.getCheckInBaggagePieces()     : null;
        Double  ciWeightPer     = bag  != null ? bag.getCheckInBaggageWeightPerPieces() : null;
        Integer cbPieces        = bag  != null ? bag.getCabinBaggagePieces()        : null;
        Double  cbWeightPer     = bag  != null ? bag.getCabinBaggageWeightPerPieces() : null;
        ...
        BookingConfirmedEvent event = BookingConfirmedEvent.builder()
                ...
                .taxesAndFees(taxes)
                // Baggage
                .checkingBaggagePieces(ciPieces)
                .checkingBaggageWeightPerPiece(ciWeightPer)
                .cabinBaggagePieces(cbPieces)
                .cabinBaggageWeightPerPieces(cbWeightPer)
                // Policies
                .freeDateChange(fare != null ? fare.getFreeDataChange()       : null)
